...
type BoardRepository interface {
	...
	GetBoards(userID uint, pageNumber, pageSize int) (*internal_models.BoardList, error)
	...
	AssignUserRoleBoard(userID uint, boardID uint, AssignUserID uint, role string) error
